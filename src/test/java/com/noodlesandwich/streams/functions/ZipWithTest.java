...
public final class ZipWithTest {
    ...
    zips_two_populated_streams_of_the_same_length_and_type() {
        Stream<Integer> streamOne = Streams.of(1, 2, 3, 4, 5);
        Stream<Integer> streamTwo = Streams.of(7, 4, 9, 1, 10);
    ...
    truncates_a_pairing_of_a_long_stream_with_a_short_stream_using_the_short() {
        Stream<Integer> streamOne = Streams.of(1, 2, 3, 4, 5);
        Stream<Integer> streamTwo = Streams.of(7, 4, 9);
    ...
    @Test public void
    is_repeatable() {
        Stream<Integer> zippedStream = Streams.of(1, 2, 3, 4, 5).zipWith(Streams.of(6, 7, 8, 9, 10), mutable());
